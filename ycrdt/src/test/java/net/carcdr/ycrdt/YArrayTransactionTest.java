...
public class YArrayTransactionTest {
    ...
    public void testInsertStringWithTransaction() {
        ...
        try (YDoc doc2 = new YDoc();
             YArray array2 = doc2.getArray("test")) {
    ...
    public void testInsertDoubleWithTransaction() {
        ...
        try (YDoc doc2 = new YDoc();
            ...
            assertEquals(1.0, array2.getDouble(0), 0.001);
            assertEquals(2.0, array2.getDouble(1), 0.001);
            assertEquals(3.0, array2.getDouble(2), 0.001);
        }
    }
    ...
    public void testPushStringWithTransaction() {
        ...
        try (YDoc doc2 = new YDoc();
             YArray array2 = doc2.getArray("test")) {
            assertEquals(3, array2.length());
            assertEquals("First", array2.getString(0));
            assertEquals("Second", array2.getString(1));
            assertEquals("Third", array2.getString(2));
        }
    }
    ...
    public void testPushDoubleWithTransaction() {
        ...
        try (YDoc doc2 = new YDoc();
             YArray array2 = doc2.getArray("test")) {
            assertEquals(3, array2.length());
            assertEquals(10.5, array2.getDouble(0), 0.001);
            assertEquals(20.5, array2.getDouble(1), 0.001);
            assertEquals(30.5, array2.getDouble(2), 0.001);
        }
    }
    ...
    public void testInsertDocWithTransaction() {
        ...
        try (YDoc parent2 = new YDoc();
             YArray array2 = parent2.getArray("test")) {
    ...
    public void testPushDocWithTransaction() {
        ...
        try (YDoc parent2 = new YDoc();
             YArray array2 = parent2.getArray("test")) {
            assertEquals(2, array2.length());
            YDoc retrieved1 = array2.getDoc(0);
            YDoc retrieved2 = array2.getDoc(1);
    ...
    public void testBatchOperationsWithTransaction() {
        ...
        try (YDoc doc2 = new YDoc();
            ...
            assertEquals(1.0, array2.getDouble(1), 0.001);
            assertEquals("C", array2.getString(2));
            assertEquals("B", array2.getString(3));
            assertEquals(2.0, array2.getDouble(4), 0.001);
        }
    }
    ...
    public void testComplexBatchOperations() {
        ...
        try (YDoc doc2 = new YDoc();
             YArray array2 = doc2.getArray("test")) {
            assertEquals(12, array2.length());
            assertEquals(0.0, array2.getDouble(0), 0.001);
            assertEquals(6.0, array2.getDouble(4), 0.001);
            assertEquals("Item0", array2.getString(7));
        }
    }
