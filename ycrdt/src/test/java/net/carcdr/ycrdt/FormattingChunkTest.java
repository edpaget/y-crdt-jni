...
public class FormattingChunkTest {
    ...
    public void testFormattingChunkCreation() {
        ...
        attrs.put("bold", true);
        FormattingChunk chunk = new FormattingChunk("Hello", attrs);
    ...
    public void testFormattingChunkWithoutAttributes() {
        FormattingChunk chunk = new FormattingChunk("World", null);
    ...
    public void testFormattingChunkImmutableAttributes() {
        ...
        FormattingChunk chunk = new FormattingChunk("Test", attrs);
    ...
    public void testFormattingChunkEquals() {
        ...
        FormattingChunk chunk1 = new FormattingChunk("Hello", attrs1);

        Map<String, Object> attrs2 = new HashMap<>();
        attrs2.put("bold", true);
        FormattingChunk chunk2 = new FormattingChunk("Hello", attrs2);
