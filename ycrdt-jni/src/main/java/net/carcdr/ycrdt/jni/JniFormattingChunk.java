 ...
 * }</pre>
 *
 * @see JniYXmlText#getFormattingChunks()
 * @since 0.1.0
 */
public final class JniFormattingChunk implements FormattingChunk {
     ...
     */
    public JniFormattingChunk(String text, Map<String, Object> attributes) {
        if (text == null) {
    ...
    public boolean equals(Object o) {
        ...
        JniFormattingChunk that = (JniFormattingChunk) o;
    ...
    public String toString() {
        if (attributes.isEmpty()) {
            return "JniFormattingChunk{text='" + text + "'}";
        }
        return "JniFormattingChunk{text='" + text + "', attributes=" + attributes + "}";
    }
}
