...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlText_nativeGetXmlText(
    mut env: JNIEnv,
    _class: JClass,
    doc_ptr: jlong,
    name: JString,
...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlText_nativeToStringWithTxn(
    mut env: JNIEnv,
    _class: JClass,
    doc_ptr: jlong,
    xml_text_ptr: jlong,
...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlText_nativeInsertWithTxn(
    mut env: JNIEnv,
    _class: JClass,
    doc_ptr: jlong,
    xml_text_ptr: jlong,
...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlText_nativePushWithTxn(
    mut env: JNIEnv,
    _class: JClass,
    doc_ptr: jlong,
    xml_text_ptr: jlong,
...
#[no_mangle]
pub unsafe extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlText_nativeInsertWithAttributesWithTxn(
    mut env: JNIEnv,
    _class: JClass,
    doc_ptr: jlong,
    xml_text_ptr: jlong,
...
/// The `attributes` parameter is a raw JNI pointer that must be valid
#[no_mangle]
pub unsafe extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlText_nativeFormatWithTxn(
    mut env: JNIEnv,
    _class: JClass,
    doc_ptr: jlong,
    xml_text_ptr: jlong,
...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlText_nativeGetParentWithTxn<'a>(
    mut env: JNIEnv<'a>,
    _class: JClass<'a>,
    doc_ptr: jlong,
    xml_text_ptr: jlong,
...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlText_nativeGetIndexInParentWithTxn(
    mut env: JNIEnv,
    _class: JClass,
    doc_ptr: jlong,
    xml_text_ptr: jlong,
...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlText_nativeGetFormattingChunksWithTxn<
    'local,
>(
