...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlElement_nativeGetXmlElement(
    mut env: JNIEnv,
    _class: JClass,
    doc_ptr: jlong,
    name: JString,
...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlElement_nativeGetTagWithTxn(
    mut env: JNIEnv,
    _class: JClass,
    doc_ptr: jlong,
...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlElement_nativeGetAttributeNamesWithTxn<
    'a,
>(
    mut env: JNIEnv<'a>,
    _class: JClass<'a>,
...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlElement_nativeToStringWithTxn(
    mut env: JNIEnv,
    _class: JClass,
    doc_ptr: jlong,
    xml_element_ptr: jlong,
...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlElement_nativeChildCountWithTxn(
    mut env: JNIEnv,
    _class: JClass,
    doc_ptr: jlong,
    xml_element_ptr: jlong,
...
#[no_mangle]
pub extern "system" fn Java_net_carcdr_ycrdt_jni_JniYXmlElement_nativeGetIndexInParentWithTxn(
    mut env: JNIEnv,
    _class: JClass,
    doc_ptr: jlong,
    xml_element_ptr: jlong,
